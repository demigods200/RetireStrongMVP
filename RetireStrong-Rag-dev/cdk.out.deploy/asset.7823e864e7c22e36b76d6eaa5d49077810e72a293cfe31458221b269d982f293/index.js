...
// apps/api-gateway/src/handlers/motivation/quiz.ts
var quiz_exports = {};
...
// packages/motivation-engine/dist/questions.js
var QUIZ_QUESTIONS = [
  {
    id: "q1",
...
// packages/shared-api/dist/schemas/auth.js
...
// packages/shared-api/dist/schemas/user.js
var UserSchema = external_exports.object({
  ...
  onboardingComplete: external_exports.boolean().optional()
});

// packages/shared-api/dist/schemas/onboarding.js
var DemographicsSchema = external_exports.object({
  age: external_exports.number().min(50).max(100),
  gender: external_exports.enum(["male", "female", "other", "prefer_not_to_say"]),
  location: external_exports.string().optional()
});
var HealthContextSchema = external_exports.object({
  activityLevel: external_exports.enum(["sedentary", "light", "moderate", "active"]),
  healthConditions: external_exports.array(external_exports.string()).default([]),
  mobilityLimitations: external_exports.array(external_exports.string()).default([]),
  equipmentAvailable: external_exports.array(external_exports.string()).default([])
});
var SchedulePreferencesSchema = external_exports.object({
  preferredDays: external_exports.array(external_exports.string()).min(1, "Select at least one day"),
  preferredTime: external_exports.enum(["morning", "afternoon", "evening", "flexible"]),
  sessionDuration: external_exports.number().min(10).max(60)
});
var OnboardingDataSchema = external_exports.object({
  demographics: DemographicsSchema,
  healthContext: HealthContextSchema,
  goals: external_exports.array(external_exports.string()).min(1, "Select at least one goal"),
  schedulePreferences: SchedulePreferencesSchema
});
var OnboardingRequestSchema = external_exports.object({
  userId: external_exports.string(),
  onboardingData: OnboardingDataSchema
});
var OnboardingResponseSchema = external_exports.object({
  success: external_exports.boolean(),
  data: external_exports.object({
    userId: external_exports.string(),
    onboardingComplete: external_exports.boolean()
  })
});

// packages/shared-api/dist/schemas/motivation.js
var QuizAnswerSchema = external_exports.object({
  questionId: external_exports.string(),
  value: external_exports.number().min(1).max(5)
});
var QuizSubmissionSchema = external_exports.object({
  userId: external_exports.string(),
  answers: external_exports.array(QuizAnswerSchema).min(10).max(15)
});
var MotivationProfileSchema = external_exports.object({
  primaryMotivator: external_exports.string(),
  secondaryMotivators: external_exports.array(external_exports.string()),
  scores: external_exports.record(external_exports.string(), external_exports.number())
});
var ToneConfigSchema = external_exports.object({
  formality: external_exports.enum(["casual", "professional", "warm"]),
  encouragement: external_exports.enum(["gentle", "moderate", "energetic"]),
  directness: external_exports.enum(["subtle", "balanced", "direct"]),
  humor: external_exports.enum(["none", "light", "moderate"])
});
var CoachPersonaSchema = external_exports.object({
  name: external_exports.string(),
  description: external_exports.string(),
  tone: ToneConfigSchema,
  avatar: external_exports.string().optional()
});
var QuizResponseSchema = external_exports.object({
  success: external_exports.boolean(),
  data: external_exports.object({
...
var QuizQuestionsResponseSchema = external_exports.object({
  success: external_exports.boolean(),
  data: external_exports.object({
...
// packages/shared-api/dist/schemas/plan.js
var MovementPrescriptionSchema = external_exports.object({
  type: external_exports.enum(["reps", "time"]),
  sets: external_exports.number(),
  reps: external_exports.string().optional(),
  seconds: external_exports.number().optional(),
  holdSeconds: external_exports.number().optional(),
  restSeconds: external_exports.number().optional(),
  notes: external_exports.string().optional()
});
var MovementInstanceSchema = external_exports.object({
  movementId: external_exports.string(),
  name: external_exports.string(),
  description: external_exports.string(),
  prescription: MovementPrescriptionSchema,
  emphasis: external_exports.array(external_exports.string()).optional(),
  cautions: external_exports.array(external_exports.string()).optional()
});
var SessionFeedbackSchema = external_exports.object({
  difficulty: external_exports.enum(["too_easy", "just_right", "too_hard"]).optional(),
  pain: external_exports.boolean().optional(),
  notes: external_exports.string().optional()
});
var MovementSessionSchema = external_exports.object({
  sessionId: external_exports.string(),
  planId: external_exports.string(),
  userId: external_exports.string(),
  dayIndex: external_exports.number(),
  focus: external_exports.string(),
  status: external_exports.enum(["pending", "completed"]),
  scheduledDate: external_exports.string(),
  movements: external_exports.array(MovementInstanceSchema),
  completedAt: external_exports.string().optional(),
  feedback: SessionFeedbackSchema.optional()
});
var MovementPlanSchema = external_exports.object({
  planId: external_exports.string(),
  userId: external_exports.string(),
  createdAt: external_exports.string(),
  startDate: external_exports.string(),
  schedule: external_exports.array(external_exports.string()),
  sessions: external_exports.array(MovementSessionSchema),
  cautions: external_exports.array(external_exports.string())
});
var CreateStarterPlanRequestSchema = external_exports.object({
  userId: external_exports.string()
});
var PlanResponseSchema = external_exports.object({
  success: external_exports.boolean(),
  data: external_exports.object({
    plan: MovementPlanSchema
  })
});
var GetSessionRequestSchema = external_exports.object({
  userId: external_exports.string(),
  sessionId: external_exports.string()
});
...
var CompleteSessionRequestSchema = external_exports.object({
  userId: external_exports.string(),
  sessionId: external_exports.string(),
  feedback: SessionFeedbackSchema.optional()
});
var CompleteSessionResponseSchema = external_exports.object({
  success: external_exports.boolean(),
  data: MovementSessionSchema
});
